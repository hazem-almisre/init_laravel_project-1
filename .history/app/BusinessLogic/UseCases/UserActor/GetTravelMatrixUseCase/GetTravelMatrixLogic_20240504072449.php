...
class GetTravelMatrixLogic implements UseCase {
    ...
    public function execute() : Result {
        ...
        if (!$reservation) {
            ...
            "seatNumbers" =>  json_encodearray_fill(0,47,0)
            ];
            $json = json_encode($reservationData['seatNumbers']);
            return $this->output->sendSuccess((new GetTravelMatrixOutput($json))->getDataAsObject() , 'Success');
