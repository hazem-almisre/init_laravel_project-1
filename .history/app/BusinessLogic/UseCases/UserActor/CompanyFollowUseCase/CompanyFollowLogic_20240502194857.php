...
class CompanyFollowLogic implements UseCase {
    ...
    public function execute() : Result {
        ...
        if ($follow) {
            ...
            $this->output->sendSuccess((new CompanyF($travel))->getDataAsObject() , 'Success')
        ...
        else
        {
            ...
            $this->output->sendSuccess((new SearchAndFilterTravelOutput($travel))->getDataAsObject() , 'Success')
            :$this->output->sendFailed(null,ErrorMessage::$AccountNotFound);
        }
