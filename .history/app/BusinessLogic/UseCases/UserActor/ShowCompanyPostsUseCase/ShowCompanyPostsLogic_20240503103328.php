...
class ShowCompanyPostsLogic implements UseCase {
    ...
    public function execute() : Result {
        ...
        $posts = $this->repository->re1adRepository()->getRecordsByValues("companyId",$this->input->getCompanyId());

        return $this->output->sendSuccess((new ShowCompanyPostsOutput($posts))->getOutputAsArray() , 'Success');
